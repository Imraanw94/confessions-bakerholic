...
// Users can edit and delete their own recommendations
// Admins can edit and delete any user's recommendation
function RecommendedProduct(props) {
  ...
  function editRecommendedProductHandler() {
    ...
    const recipe = linkRef.current.value;
    const visualLink = picRef.current.value;

...
// This page will allow the user to input their information to be contacted by the business at another time
function ContactPage(props) {
  ...
  // When a user completed the contact form and submits, save the information to the DB and inform the user whether it was a success or not
  function submitContactInfo() {
    ...
    // Send the contact object to the backend via a POST method
    addContactHandler(contact);
  }

  // Asynchronous function for adding a Contact
